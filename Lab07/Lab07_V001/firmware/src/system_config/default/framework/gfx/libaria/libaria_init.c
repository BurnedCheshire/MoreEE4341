...
int32_t libaria_initialize(void)
{
    ...
    laScheme_Initialize(&Try Again, GFX_COLOR_MODE_RGB_332);
    Try Again.base = 0x52;
    Try Again.highlight = 0x57;
    Try Again.highlightLight = 0x97;
    Try Again.shadow = 0x92;
    Try Again.shadowDark = 0x49;
    Try Again.foreground = 0x0;
    Try Again.foregroundInactive = 0xDB;
    Try Again.foregroundDisabled = 0x92;
    Try Again.background = 0x76;
    Try Again.backgroundInactive = 0xDB;
    Try Again.backgroundDisabled = 0x46;
    Try Again.text = 0x0;
    Try Again.textHighlight = 0xCF;
    Try Again.textHighlightText = 0xFF;
    Try Again.textInactive = 0xDB;
    Try Again.textDisabled = 0x92;
...
static void ScreenCreate_screen1(laScreen* screen)
{
    ...
    laWidget_SetSize((laWidget*)layer0, 200, 320);
    laWidget_SetBackgroundType((laWidget*)layer0, LA_WIDGET_BACKGROUND_FILL);
    laWidget_SetScheme((laWidget*)layer0, &Try Again);
    ...
    laWidget_SetScheme((laWidget*)ButtonWidget5, &Try Again);
    ...
    laWidget_SetScheme((laWidget*)SliderWidget7, &Try Again);
    ...
    laWidget_SetScheme((laWidget*)RectangleWidget8, &Try Again);
    ...
    laWidget_SetScheme((laWidget*)ImageWidget9, &Try Again);
    ...
    laWidget_SetScheme((laWidget*)KeyPadWidget10, &Try Again);
