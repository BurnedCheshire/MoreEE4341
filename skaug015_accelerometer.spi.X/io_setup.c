...
// Add a comment for each edit you make, so you don't forget
    ...
    //for input -> pin to peripheral
    //for output -> peripheral to pin
    
        U1RXRbits.U1RXR = 0b0010;
        //UART receive bits peripheral
        RPF5Rbits.RPF5R = 0b0011;
        //sets the peripheral pin UART tx
...
void buttons(void)
{
    ...
    {
        delay(5);
            //5ms delay for debounce, it then double checks
        if(!BUTTON1)
        {
